...
contract BlazePhoenixSolver {
    ...
    ///         liquidity sets.
    ///
    ///         200 bps (2%) band: tight enough to exclude mis-priced pools
    ...
    ///         marginal-rate reading.
    uint16  internal constant MEDIAN_FILTER_BPS    = 200;   // ±2%
