...
# shape - the skipped leg is credited at full scale - so the test observes the Router's guard.
 ...
 dict(nome="extras: LENGTHS only (a row with every fee replaced would pass)",
      ...
      new="        // MUTANTE: laco dos fees removido",
      teste="testFuzz_RenouncedExtrasAreComparedElementWise"),
 dict(nome="extras: spacings ignored (half the derivation input left free)",
      ...
      new="        // MUTANTE: laco dos spacings removido",
      teste="testFuzz_RenouncedExtrasAreComparedElementWise"),
