...
The protocol papers, released with the repository so that a Zenodo record (and its DOI) archives the text beside the code it describes.

| file | what | text licence |
|---|---|---|
| `BlazePhoenix_Whitepaper_v2.2.pdf` | Technical Whitepaper, Version 2.2 — the aggregator alone: mechanism, mathematics, security model, the verification apparatus measured | CC BY 4.0 |
