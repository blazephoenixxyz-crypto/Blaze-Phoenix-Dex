...
`.github/scripts/mutants.py` holds **267 hand-written mutants**, each pairing one exact line of
...
**267 of 267 are killed.** The figure is always printed beside its denominator: it is adequacy
