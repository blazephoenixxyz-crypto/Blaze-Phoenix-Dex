...
`.github/scripts/mutants.py` holds **266 hand-written mutants**, each pairing one exact line of
...
**266 of 266 are killed.** The figure is always printed beside its denominator: it is adequacy
